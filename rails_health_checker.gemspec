...
require "rails_health_checker/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "rails_health_checker"
  s.version     = RailsHealthChecker::VERSION
  s.authors     = ["maksim karganov"]
  s.email       = ["maksim.karganov@gmail.com"]
  s.homepage    = "https://github.com/mkarganov/rails_health_checker"
